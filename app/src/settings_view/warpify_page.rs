...
use super::settings_page::{
    render_body_item, render_dropdown_item, render_page_title, settings_display_text,
    settings_display_text_static, AdditionalInfo, Category, LocalOnlyIconState, MatchData,
...
pub fn init_actions_from_parent_view<T: Action + Clone>(
    ...
    if FeatureFlag::SSHTmuxWrapper.is_enabled() {
        toggle_binding_pairs.push(ToggleSettingActionPair::new(
            settings_display_text_static("SSH session detection for Warpification"),
...
impl WarpifyPageView {
    pub fn new(ctx: &mut ViewContext<Self>) -> Self {
        ...
        let add_denylisted_ssh_editor = ctx.add_typed_action_view(|ctx| {
            let mut input = SubmittableTextInput::new(ctx);
            input.set_placeholder_text(&settings_display_text("host (supports regex)"), ctx);
            input
        });
    ...
    fn build_page(ctx: &mut ViewContext<Self>) -> PageType<Self> {
        let mut categories = vec![
            ...
            Category::new(
                tr(current_locale(), MessageId::WarpifySubshells).into_owned(),
                vec![Box::new(SubshellsWidget::default())],
            )
            .with_subtitle(settings_display_text_static(
                ...
                .is_supported_on_current_platform()
        {
            categories.push(
                Category::new(
                    tr(current_locale(), MessageId::WarpifySsh).into_owned(),
    ...
    fn render_subshells_section(
        ...
        column.add_child(
            view.build_input_list(
                settings_display_text_static("Added commands"),
        ...
        column.add_child(
            view.build_input_list(
                settings_display_text_static("Denylisted commands"),
        ...
        add_setting(
            ...
            move || {
                render_body_item::<WarpifyPageAction>(
                    settings_display_text_static("Warpify SSH Sessions").into(),
                    None,
            ...
            add_setting(
                ...
                move || {
                    Container::new(render_dropdown_item(
                        appearance,
                        settings_display_text_static("Install SSH extension"),
                        Some(settings_display_text_static(
                            SSH_EXTENSION_INSTALL_MODE_DESCRIPTION,
                        )),
                        None,
                        LocalOnlyIconState::for_setting(
        ...
        add_setting(
            ...
            move || {
                ...
                column.add_child(render_body_item::<WarpifyPageAction>(
                    settings_display_text_static("Use Tmux Warpification").into(),
                    Some(AdditionalInfo {
                ...
                column.add_child(
                    ui_builder
                        .paragraph(settings_display_text(SSH_TMUX_WARPIFICATION_DESCRIPTION))
                        .with_style(UiComponentStyles {
                ...
                if enable_ssh_warpification && should_prompt_ssh_tmux_wrapper {
                    ...
                    column.add_child(
                        view.build_input_list(
                            settings_display_text_static("Denylisted hosts"),
