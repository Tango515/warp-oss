...
use super::{
    settings_page::{
        render_sub_header, settings_display_text, LocalOnlyIconState, MatchData, PageType,
...
pub fn search_placeholder() -> std::borrow::Cow<'static, str> {
    crate::i18n::tr(
        crate::i18n::current_locale(),
        MessageId::KeybindingsSearchPlaceholder,
    )
}
fn shortcut_conflict_warning_text() -> std::borrow::Cow<'static, str> {
    crate::i18n::tr(
        crate::i18n::current_locale(),
        MessageId::KeybindingsConflictWarning,
    )
}
const KEYBINDINGS_PAGE_SHORTCUT: &str = "workspace:toggle_keybindings_page";
fn reset_button_text() -> std::borrow::Cow<'static, str> {
    crate::i18n::tr(crate::i18n::current_locale(), MessageId::KeybindingsDefault)
}
fn cancel_button_text() -> std::borrow::Cow<'static, str> {
    crate::i18n::tr(crate::i18n::current_locale(), MessageId::KeybindingsCancel)
}
fn clear_button_text() -> std::borrow::Cow<'static, str> {
    crate::i18n::tr(crate::i18n::current_locale(), MessageId::KeybindingsClear)
}
fn save_button_text() -> std::borrow::Cow<'static, str> {
    crate::i18n::tr(crate::i18n::current_locale(), MessageId::KeybindingsSave)
}
...
fn render_text(
    ...
    let text = settings_display_text(text);
    let mut text = appearance.ui_builder().wrappable_text(text, true);
    ...
    fn render(
        ...
        let local_only_icon_state = if *CloudPreferencesSettings::as_ref(app).settings_sync_enabled
        {
            Some(LocalOnlyIconState::Visible {
                ...
                custom_tooltip: Some(settings_display_text(
