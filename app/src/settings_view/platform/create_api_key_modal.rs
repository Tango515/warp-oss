...
use crate::settings_view::settings_page::{settings_display_text, settings_display_text_static};
...
impl ApiKeyType {
    fn description(&self) -> &'static str {
        settings_display_text_static(match self {
            ApiKeyType::Personal => {
...
impl CreateApiKeyModal {
    pub fn new(ctx: &mut ViewContext<Self>) -> Self {
        ...
        let name_editor = ctx.add_typed_action_view(|ctx| {
            ...
            editor.set_placeholder_text(&settings_display_text("Warp API Key"), ctx);
            editor
        });
                    ...
                    Some(RenderableOptionConfig {
                        ...
                        label: Some(LabelConfig {
                            label: match key_type {
                                ApiKeyType::Personal => settings_display_text("Personal").into(),
                                ApiKeyType::Team => settings_display_text("Team").into(),
                            },
    ...
    fn render_success_content(&self, app: &AppContext) -> Box<dyn Element> {
        ...
        let done_button = appearance
            ...
            .with_text_label(settings_display_text("Done"))
            ...
            _ => {
                ...
                let mut create_button_hover = appearance
                    ...
                    .with_text_label(if is_pending {
                        settings_display_text("Creating...")
                    } else {
                        settings_display_text("Create key")
                    })
                    .with_style(button_style)
                    .build()
                    .on_click(move |ctx, _, _| {
                ...
                let expiration_label = Text::new(
                    settings_display_text("Expiration"),
                    appearance.ui_font_family(),
                    LABEL_FONT_SIZE,
                )
                .with_color(theme.active_ui_text_color().into())
