...
impl StartupShellView {
    ...
    pub fn new(ctx: &mut ViewContext<Self>) -> Self {
        ...
        let shell_editor = ctx.add_typed_action_view(|ctx| {
            ...
            editor.set_placeholder_text(&settings_display_text("Executable path"), ctx);
    ...
    fn update_dropdown_state(
        ...
        dropdown.update(ctx, |dropdown, ctx| {
            let mut items = vec![DropdownItem::new(
                settings_display_text_static("Default"),
                ...
                for shell_entry in model.get_available_shells() {
                    items.push(DropdownItem::new(
                        settings_display_text(
                            model.display_name_for_shell(shell_entry).into_owned(),
                        ),
            ...
            items.push(DropdownItem::new(
                settings_display_text_static("Custom"),
