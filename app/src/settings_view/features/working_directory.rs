    ...
    fn render(&self, app: &warpui::AppContext) -> Box<dyn warpui::Element> {
        ...
        if config.advanced_mode {
            let items = Flex::column()
                ...
                .with_children([
                    ui_builder
                        .label(settings_display_text("New window"))
                        .build()
                        .finish(),
                    render_row(
                    ...
                    ui_builder
                        .label(settings_display_text("New tab"))
                        .build()
                        .finish(),
                    render_row(
                    ...
                    ui_builder
                        .label(settings_display_text("Split pane"))
                        .build()
                        .finish(),
                    render_row(
...
fn init_top_level_dropdown(
    ...
    items.push(DropdownItem::new(
        settings_display_text_static("Advanced").to_string(),
...
fn create_editor(
    ...
    let editor = {
        ...
        ctx.add_typed_action_view(|ctx| {
            ...
            editor.set_placeholder_text(&settings_display_text("Directory path"), ctx);
            editor
        })
    };
    let initial_value = {
