    ...
    fn error_text(&self) -> Option<String> {
        match self.input_error_state {
            Some(SpendingLimitModalInputErrorState::InvalidNumberFormat) => Some(
                settings_display_text("Please enter a valid currency amount"),
            ),
            Some(SpendingLimitModalInputErrorState::NumberOutOfRange) => Some(
                settings_display_text("Please enter a price between $0.01 and $10,000,000"),
            ),
            None => None,
        }
    }
...
impl View for SpendingLimitModal {
    ...
    fn render(&self, app: &AppContext) -> Box<dyn Element> {
        ...
        let description_text = Text::new(
            settings_display_text("Warp will prevent use of premium models when this dollar limit is reached. Resets on a monthly basis."),
        ...
        let mut update_button = appearance
            ...
            .with_text_label(settings_display_text("Update"))
