...
pub struct SettingsUmbrella {
    pub label_message_id: MessageId,
...
impl SettingsUmbrella {
    pub fn new(label_message_id: MessageId, subpages: Vec<SettingsSection>) -> Self {
    ...
    pub fn render_umbrella_row(&self, appearance: &Appearance) -> Hoverable {
        ...
        appearance
            ...
            .with_text_and_icon_label(TextAndIcon::new(
                ...
                tr(current_locale(), self.label_message_id).into_owned(),
    ...
    pub fn render_subpage_button(
        ...
        let label = section.localized_title(current_locale()) + &match_data.to_string();
