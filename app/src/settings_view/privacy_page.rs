...
use crate::settings_view::settings_page::{settings_display_text, CONTENT_FONT_SIZE};
...
fn safe_mode_title() -> Cow<'static, str> {
    tr(current_locale(), MessageId::PrivacySecretRedaction)
}

fn safe_mode_description() -> Cow<'static, str> {
    tr(
        current_locale(),
        MessageId::PrivacySecretRedactionDescription,
    )
}

fn user_secret_regex_title() -> Cow<'static, str> {
    tr(current_locale(), MessageId::PrivacyCustomSecretRedaction)
}

fn user_secret_regex_description() -> Cow<'static, str> {
    tr(current_locale(), MessageId::PrivacyCustomSecretDescription)
}
...
fn telemetry_title() -> Cow<'static, str> {
    tr(current_locale(), MessageId::PrivacyTelemetryTitle)
}

fn telemetry_description() -> Cow<'static, str> {
    tr(current_locale(), MessageId::PrivacyTelemetryDescription)
}

fn telemetry_free_tier_note() -> Cow<'static, str> {
    tr(current_locale(), MessageId::PrivacyTelemetryFreeTierNote)
}
...
fn data_management_title() -> Cow<'static, str> {
    tr(current_locale(), MessageId::PrivacyDataManagementTitle)
}

fn data_management_description() -> Cow<'static, str> {
    tr(
        current_locale(),
        MessageId::PrivacyDataManagementDescription,
    )
}

fn data_management_link_text() -> Cow<'static, str> {
    tr(current_locale(), MessageId::PrivacyDataManagementLinkText)
}

fn privacy_policy_title() -> Cow<'static, str> {
    tr(current_locale(), MessageId::PrivacyPrivacyPolicyTitle)
}

fn privacy_policy_link_text() -> Cow<'static, str> {
    tr(current_locale(), MessageId::PrivacyPrivacyPolicyLinkText)
}
...
impl PrivacyPageView {
    ...
    pub fn new(ctx: &mut ViewContext<PrivacyPageView>) -> Self {
        ...
        let add_regex_modal_view = ctx.add_typed_action_view(|ctx| {
            Modal::new(
                Some(settings_display_text("Add regex pattern")),
                add_regex_body,
                ctx,
            )
    ...
    fn build_page() -> PageType<Self> {
        ...
        PageType::new_uncategorized(
            widgets,
            Some(tr(current_locale(), MessageId::SettingsPrivacy).into_owned()),
        )
    }
...
impl SettingsWidget for SecretRedactionWidget {
    ...
    fn render(
        ...
        let mut column = Flex::column()
            ...
            .with_child(
                ui_builder
                    .paragraph(safe_mode_description())
                    .with_style(UiComponentStyles {
                        font_color: Some(description_text_color),
                        ...
                        Expanded::new(
                            ...
                            Flex::column()
                                .with_child(self.render_section_title(
                                    user_secret_regex_title().into_owned(),
                                    appearance,
                                ))
                                .with_child(self.render_description(
                                    user_secret_regex_description().into_owned(),
                                    appearance,
...
impl SettingsWidget for AppAnalyticsWidget {
    ...
    fn render(
        ...
        let description: Cow<'static, str> = if is_enterprise {
            Cow::Borrowed(TELEMETRY_DESCRIPTION_OLD)
        } else {
...
impl SettingsWidget for DataManagementWidget {
    ...
    fn render(
        ...
        Flex::column()
            .with_child(render_body_item::<PrivacyPageAction>(
                data_management_title().into_owned(),
                None,
                // Not rendering a setting, so no need to show local only icon state.
                LocalOnlyIconState::Hidden,
                ToggleState::Enabled,
            ...
            .with_child(
                Align::new(
                    appearance
                        .ui_builder()
                        .link(
                            data_management_link_text().into_owned(),
                            None,
                            Some(Box::new(|ctx| {
                                ctx.dispatch_typed_action(
                                    PrivacyPageAction::OpenDataManagementWebpage,
...
impl SettingsWidget for PrivacyPolicyWidget {
    ...
    fn render(
        ...
        Flex::column()
            .with_child(render_body_item::<PrivacyPageAction>(
                privacy_policy_title().into_owned(),
                None,
                // Not rendering a setting, so no need to show local only icon state.
                LocalOnlyIconState::Hidden,
                ToggleState::Enabled,
            ...
            .with_child(
                Align::new(
                    appearance
                        .ui_builder()
                        .link(
                            privacy_policy_link_text().into_owned(),
