...
use super::{
    settings_page::{
        ...
        settings_display_text, settings_display_text_static, SettingsPageEvent, SettingsPageMeta,
...
pub fn init_actions_from_parent_view<T: Action + Clone>(
    ...
    let compact_mode_label = tr(current_locale(), MessageId::AppearanceCompactMode);
    let sync_with_os_label = tr(current_locale(), MessageId::AppearanceSyncWithOs);
    ...
    let cursor_blink_label = tr(current_locale(), MessageId::AppearanceCursorBlink);
    ...
    let jump_to_bottom_label = tr(current_locale(), MessageId::AppearanceJumpToBottom);
    toggle_binding_pairs.push(
        ToggleSettingActionPair::new(
    ...
    let block_dividers_label = tr(current_locale(), MessageId::AppearanceBlockDividers);
    toggle_binding_pairs.push(
        ToggleSettingActionPair::new(
            &block_dividers_label,
            builder(SettingsAction::AppearancePageToggle(
    ...
    let dim_inactive_panes_label = tr(current_locale(), MessageId::AppearanceDimInactivePanes);
    toggle_binding_pairs.push(ToggleSettingActionPair::new(
        &dim_inactive_panes_label,
        builder(SettingsAction::AppearancePageToggle(
    ...
    app.register_fixed_bindings(vec![FixedBinding::empty(
        tr(current_locale(), MessageId::AppearanceStartInputTop).into_owned(),
        builder(SettingsAction::AppearancePageToggle(
    ...
    app.register_fixed_bindings(vec![FixedBinding::empty(
        tr(current_locale(), MessageId::AppearancePinInputTop).into_owned(),
        builder(SettingsAction::AppearancePageToggle(
            AppearancePageAction::SetInputMode {
    ...
    app.register_fixed_bindings(vec![FixedBinding::empty(
        tr(current_locale(), MessageId::AppearancePinInputBottom).into_owned(),
        builder(SettingsAction::AppearancePageToggle(
            AppearancePageAction::SetInputMode {
    ...
    app.register_fixed_bindings(vec![FixedBinding::empty(
        tr(current_locale(), MessageId::AppearanceToggleInputMode).into_owned(),
        builder(SettingsAction::AppearancePageToggle(
    ...
    toggle_binding_pairs.push(
        ToggleSettingActionPair::new(
            &tr(current_locale(), MessageId::AppearanceTabIndicators),
            builder(SettingsAction::AppearancePageToggle(
    ...
    if !FeatureFlag::OpenWarpNewSettingsModes.is_enabled() {
        let show_code_review_label =
            tr(current_locale(), MessageId::AppearanceShowCodeReviewButton);
        let hide_code_review_label =
            tr(current_locale(), MessageId::AppearanceHideCodeReviewButton);
        toggle_binding_pairs.push(
            ToggleSettingActionPair::custom(
                SettingActionPairDescriptions::new(
                    &show_code_review_label,
                    &hide_code_review_label,
                ),
                builder(SettingsAction::AppearancePageToggle(
    ...
    toggle_binding_pairs.push(
        ToggleSettingActionPair::new(
            &tr(current_locale(), MessageId::AppearanceFocusFollowsMouse),
            builder(SettingsAction::AppearancePageToggle(
    ...
    if FeatureFlag::FullScreenZenMode.is_enabled() {
        ...
        app.register_fixed_bindings([
            FixedBinding::empty(
                tr(current_locale(), MessageId::AppearanceAlwaysShowTabBar).into_owned(),
                builder(SettingsAction::AppearancePageToggle(
            ...
            .with_group(bindings::BindingGroup::Settings.as_str()),
            FixedBinding::empty(
                tr(current_locale(), MessageId::AppearanceHideTabBarFullscreen).into_owned(),
                builder(SettingsAction::AppearancePageToggle(
                    AppearancePageAction::SetWorkspaceDecorationVisibility(
            ...
            .with_group(bindings::BindingGroup::Settings.as_str()),
            FixedBinding::empty(
                tr(current_locale(), MessageId::AppearanceShowTabBarOnHover).into_owned(),
                builder(SettingsAction::AppearancePageToggle(
                    AppearancePageAction::SetWorkspaceDecorationVisibility(
        ...
        toggle_binding_pairs.push(
            ToggleSettingActionPair::new(
                &tr(current_locale(), MessageId::AppearanceZenMode),
                builder(SettingsAction::AppearancePageToggle(
...
impl AppearanceSettingsPageView {
    ...
    fn build_page(ctx: &mut ViewContext<Self>) -> PageType<Self> {
        let mut categories = vec![Category::new(
            settings_display_text_static("Themes"),
            vec![
        ...
        if AppIconSettings::as_ref(ctx).is_supported_on_current_platform() {
            categories.push(Category::new(
                settings_display_text_static("Icon"),
        ...
        if !window_settings_widgets.is_empty() {
            categories.push(Category::new(
                settings_display_text_static("Window"),
        ...
        categories.push(Category::new(
            settings_display_text_static("Input"),
            category_widgets,
        ));

        categories.push(Category::new(
            settings_display_text_static("Panes"),
            vec![
        ...
        categories.push(Category::new(
            settings_display_text_static("Blocks"),
        ...
        categories.push(Category::new(
            settings_display_text_static("Text"),
            text_settings_widgets,
        ));

        categories.push(Category::new(
            settings_display_text_static("Cursor"),
            vec![
        ...
        categories.push(Category::new(
            settings_display_text_static("Tabs"),
            tab_settings_widgets,
        ));

        categories.push(Category::new(
            settings_display_text_static("Full-screen Apps"),
    ...
    fn render(
        ...
        Align::new(
            appearance
                .ui_builder()
                .link(
                    settings_display_text_static("Create your own custom theme").to_string(),
...
impl ThemeSelectWidget {
    fn render_theme_option(
        ...
        let mode_ui_label = match theme_chooser_mode {
            ...
            ThemeChooserMode::SystemAgnostic => settings_display_text_static("Current theme"),
        };
        ...
        Flex::column()
            ...
            .with_child(
                appearance
                    .ui_builder()
                    .span(
                        settings_display_text("Automatically switch between light and dark themes when your system does.")
                            .to_string(),
                    )
                    .with_style(
...
impl SettingsWidget for CustomAppIconWidget {
    ...
    fn render(
        ...
        let dropdown = render_dropdown_item(
            appearance,
            settings_display_text_static("Customize your app icon"),
            show_bundle_warning.then_some(settings_display_text_static(
...
impl SettingsWidget for CustomWindowSizeWidget {
    ...
    fn render(
        ...
        let mut column = Flex::column().with_child(render_body_item::<AppearancePageAction>(
            settings_display_text_static("Open new windows with custom size").into(),
            None,
            LocalOnlyIconState::for_setting(
        ...
        if *window_settings.open_windows_at_custom_size.value() {
            column.add_child(
                Container::new(render_body_item::<AppearancePageAction>(
                    settings_display_text_static("Columns").into(),
                    None,
            ...
            column.add_child(
                Container::new(render_body_item::<AppearancePageAction>(
                    settings_display_text_static("Rows").into(),
                    None,
                    // We show the local-only icon for this with the toggle, not the individual inputs.
                    LocalOnlyIconState::Hidden,
                    ToggleState::Enabled,
...
impl SettingsWidget for ToolsPanelStateScopeWidget {
    ...
    fn render(
        ...
        render_body_item::<AppearancePageAction>(
            settings_display_text_static("Tools panel visibility is consistent across tabs")
                .to_string(),
            None,
            LocalOnlyIconState::for_setting(
...
impl SettingsWidget for InputTypeWidget {
    ...
    fn render(
        ...
        render_body_item::<AppearancePageAction>(
            settings_display_text_static("Input type").into(),
            None,
            LocalOnlyIconState::Hidden,
            ToggleState::Enabled,
            appearance,
...
impl SettingsWidget for InputModeWidget {
    ...
    fn render(
        ...
        render_dropdown_item(
            appearance,
            settings_display_text_static("Input position"),
            None,
            None,
            LocalOnlyIconState::for_setting(
...
impl SettingsWidget for DimInactivePanesWidget {
    ...
    fn render(
        ...
        render_body_item::<AppearancePageAction>(
            settings_display_text_static("Dim inactive panes").into(),
            None,
            LocalOnlyIconState::for_setting(
...
impl SettingsWidget for FocusFollowsMouseWidget {
    ...
    fn render(
        ...
        render_body_item::<AppearancePageAction>(
            settings_display_text_static("Focus follows mouse").into(),
            None,
            LocalOnlyIconState::for_setting(
...
impl SettingsWidget for CompactModeWidget {
    ...
    fn render(
        ...
        render_body_item::<AppearancePageAction>(
            settings_display_text_static("Compact mode").into(),
            None,
            LocalOnlyIconState::for_setting(
                Spacing::storage_key(),
...
impl SettingsWidget for JumpToBottomOfBlockWidget {
    ...
    fn render(
        ...
        let enabled = block_list_settings
            ...
            .value();
        render_body_item::<AppearancePageAction>(
            settings_display_text_static("Show Jump to Bottom of Block button").into(),
            None,
            LocalOnlyIconState::for_setting(
...
impl SettingsWidget for ShowBlockDividersWidget {
    ...
    fn render(
        ...
        render_body_item::<AppearancePageAction>(
            settings_display_text_static("Show block dividers").into(),
            None,
            LocalOnlyIconState::for_setting(
...
impl SettingsWidget for AIFontWidget {
    ...
    fn render(
        ...
        ai_font.add_child(render_body_item_label::<AppearancePageAction>(
            settings_display_text_static("Agent font").to_string(),
            None,
            None,
            LocalOnlyIconState::for_setting(
        ...
        ai_font_row.add_child(
            appearance
                .ui_builder()
                .span(settings_display_text("Match terminal"))
                .build()
                .with_margin_left(2.)
...
impl TerminalFontWidget {
    fn render_line_height_editor(
        ...
        line_height.add_child(
            appearance
                .ui_builder()
                .label(settings_display_text("Line height").to_string())
                .with_style(UiComponentStyles {
                    margin: Some(Coords {
                        left: 12.,
                        ..Default::default()
...
impl SettingsWidget for TerminalFontWidget {
    ...
    fn render(
        ...
        terminal_font.add_child(render_body_item_label::<AppearancePageAction>(
            settings_display_text_static("Terminal font").to_string(),
            None,
            None,
            LocalOnlyIconState::for_setting(
                ...
                Flex::row()
                    ...
                    .with_child(
                        Shrinkable::new(
                            ...
                            appearance
                                .ui_builder()
                                .span(settings_display_text("View all available system fonts"))
                                .build()
                                .with_margin_left(2.)
                                .finish(),
                        )
        ...
        font_weight.add_child(
            appearance
                .ui_builder()
                .label(settings_display_text("Font weight").to_string())
                .with_style(UiComponentStyles {
                    font_size: Some(CONTENT_FONT_SIZE),
                    ..Default::default()
                })
        ...
        font_size.add_child(
            appearance
                .ui_builder()
                .label(settings_display_text("Font size (px)").to_string())
                .with_style(UiComponentStyles {
                    margin: Some(Coords {
                        left: 2.,
                        ..Default::default()
                ...
                .with_child(
                    Shrinkable::new(
                        ...
                        Align::new(
                            appearance
                                .ui_builder()
                                .span(settings_display_text("Notebook font size"))
                                .build()
                                .with_margin_right(16.)
                                .finish(),
                        )
...
impl SettingsWidget for ThinStrokesWidget {
    ...
    fn render(
        ...
        render_dropdown_item(
            appearance,
            settings_display_text_static("Use thin strokes"),
            None,
            None,
            LocalOnlyIconState::for_setting(
...
impl SettingsWidget for MinimumContrastWidget {
    ...
    fn render(
        ...
        render_dropdown_item(
            appearance,
            settings_display_text_static("Enforce minimum contrast"),
            None,
            None,
            LocalOnlyIconState::for_setting(
...
impl SettingsWidget for LigaturesWidget {
    ...
    fn render(
        ...
        render_body_item::<AppearancePageAction>(
            settings_display_text_static("Show ligatures in terminal").into(),
            Some(AdditionalInfo {
                mouse_state: self.info_mouse_state.clone(),
                on_click_action: None,
                secondary_text: None,
                tooltip_override_text: Some(settings_display_text(settings_display_text_static(
...
impl SettingsWidget for CursorTypeWidget {
    ...
    fn render(
        ...
        render_body_item::<AppearancePageAction>(
            settings_display_text_static("Cursor type").into(),
            None,
            LocalOnlyIconState::for_setting(
            ...
            match is_vim_mode_enabled {
                true => Flex::column()
                    .with_child(
                        appearance
                            .ui_builder()
                            .span(settings_display_text("Cursor type is disabled in Vim mode"))
                            .build()
                            .finish(),
                    )
                    .finish(),
...
impl SettingsWidget for BlinkingCursorWidget {
    ...
    fn render(
        ...
        render_body_item::<AppearancePageAction>(
            settings_display_text_static("Blinking cursor").into(),
            None,
            LocalOnlyIconState::for_setting(
                CursorBlinkEnabled::storage_key(),
                CursorBlinkEnabled::sync_to_cloud(),
...
impl SettingsWidget for TabCloseButtonPositionWidget {
    ...
    fn render(
        ...
        render_dropdown_item(
            appearance,
            settings_display_text_static("Tab close button position"),
            None,
            None,
            LocalOnlyIconState::for_setting(
...
impl SettingsWidget for TabIndicatorWidget {
    ...
    fn render(
        ...
        render_body_item::<AppearancePageAction>(
            settings_display_text_static("Show tab indicators").into(),
            None,
            LocalOnlyIconState::for_setting(
...
impl SettingsWidget for CodeReviewButtonWidget {
    ...
    fn render(
        ...
        render_body_item::<AppearancePageAction>(
            settings_display_text_static("Show code review button").into(),
            None,
            LocalOnlyIconState::for_setting(
