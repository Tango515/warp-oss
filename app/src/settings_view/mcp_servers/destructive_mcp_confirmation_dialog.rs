    ...
    fn from(variant: &DestructiveMCPConfirmationDialogVariant) -> Self {
        match *variant {
            DestructiveMCPConfirmationDialogVariant::DeleteLocal => DestructiveMCPConfirmationDialogDisplayOptions::new(
                settings_display_text("Delete MCP server?").to_string(),
                settings_display_text("This will uninstall and remove this MCP server from all your devices.").to_string(),
                settings_display_text("Delete MCP").to_string(),
                tr(current_locale(), MessageId::KeybindingsCancel).into_owned(),
            ),
            DestructiveMCPConfirmationDialogVariant::DeleteShared => DestructiveMCPConfirmationDialogDisplayOptions::new(
                settings_display_text("Delete shared MCP server?").to_string(),
                settings_display_text("This will not only delete this MCP server for yourself, but also uninstall and remove this MCP server from Warp and across all of your teammates' devices.").to_string(),
                settings_display_text("Delete MCP").to_string(),
                tr(current_locale(), MessageId::KeybindingsCancel).into_owned(),
            ),
            DestructiveMCPConfirmationDialogVariant::Unshare => DestructiveMCPConfirmationDialogDisplayOptions::new(
                settings_display_text("Remove shared MCP server from team?").to_string(),
                settings_display_text("This will uninstall and remove this MCP server from Warp and across all of your teammates' devices.").to_string(),
                settings_display_text("Remove from team").to_string(),
                tr(current_locale(), MessageId::KeybindingsCancel).into_owned(),
            ),
        }
    }
