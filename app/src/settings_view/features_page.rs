...
use super::settings_page::{
    ...
    render_local_only_icon, settings_display_text, settings_display_text_static, Category,
...
cfg_if::cfg_if! {
    if #[cfg(target_os = "macos")] {
        fn extra_meta_keys_left_text() -> std::borrow::Cow<'static, str> {
            tr(current_locale(), MessageId::FeaturesLeftOptionMeta)
        }
        fn extra_meta_keys_right_text() -> std::borrow::Cow<'static, str> {
            tr(current_locale(), MessageId::FeaturesRightOptionMeta)
        }
    } else {
        fn extra_meta_keys_left_text() -> std::borrow::Cow<'static, str> {
            tr(current_locale(), MessageId::FeaturesLeftAltMeta)
        }
        fn extra_meta_keys_right_text() -> std::borrow::Cow<'static, str> {
            tr(current_locale(), MessageId::FeaturesRightAltMeta)
        }
    }
}
...
pub fn init_actions_from_parent_view<T: Action + Clone>(
    ...
    let mut toggle_binding_pairs = vec![
        ToggleSettingActionPair::new(
            tr(current_locale(), MessageId::FeaturesCopyOnSelect).as_ref(),
        ...
        ToggleSettingActionPair::new(
            tr(current_locale(), MessageId::FeaturesLinuxSelectionClipboard).as_ref(),
            builder(SettingsAction::FeaturesPageToggle(
        ...
        ToggleSettingActionPair::new(
            tr(current_locale(), MessageId::FeaturesAutocompleteQuotes).as_ref(),
            builder(SettingsAction::FeaturesPageToggle(
        ...
        ToggleSettingActionPair::new(
            tr(current_locale(), MessageId::FeaturesRestoreWindows).as_ref(),
            builder(SettingsAction::FeaturesPageToggle(
        ...
        ToggleSettingActionPair::new(
            extra_meta_keys_left_text().as_ref(),
            builder(SettingsAction::FeaturesPageToggle(
        ...
        ToggleSettingActionPair::new(
            extra_meta_keys_right_text().as_ref(),
            builder(SettingsAction::FeaturesPageToggle(
        ...
        ToggleSettingActionPair::new(
            tr(current_locale(), MessageId::FeaturesScrollReporting).as_ref(),
            builder(SettingsAction::FeaturesPageToggle(
        ...
        ToggleSettingActionPair::new(
            tr(current_locale(), MessageId::FeaturesCompletionsWhileTyping).as_ref(),
            builder(SettingsAction::FeaturesPageToggle(
        ...
        ToggleSettingActionPair::new(
            tr(current_locale(), MessageId::FeaturesCommandCorrections).as_ref(),
            builder(SettingsAction::FeaturesPageToggle(
        ...
        ToggleSettingActionPair::new(
            tr(current_locale(), MessageId::FeaturesErrorUnderlining).as_ref(),
            builder(SettingsAction::FeaturesPageToggle(
        ...
        ToggleSettingActionPair::new(
            tr(current_locale(), MessageId::FeaturesSyntaxHighlighting).as_ref(),
            builder(SettingsAction::FeaturesPageToggle(
        ...
        ToggleSettingActionPair::new(
            tr(current_locale(), MessageId::FeaturesAudibleTerminalBell).as_ref(),
            builder(SettingsAction::FeaturesPageToggle(
        ...
        ToggleSettingActionPair::new(
            tr(current_locale(), MessageId::FeaturesAutosuggestions).as_ref(),
            builder(SettingsAction::FeaturesPageToggle(
        ...
        ToggleSettingActionPair::new(
            tr(
                current_locale(),
                MessageId::FeaturesAutosuggestionKeybindingHint,
            )
            .as_ref(),
            builder(SettingsAction::FeaturesPageToggle(
    ...
    if !FeatureFlag::SSHTmuxWrapper.is_enabled() {
        toggle_binding_pairs.push(ToggleSettingActionPair::new(
            tr(current_locale(), MessageId::FeaturesSshWrapper).as_ref(),
            builder(SettingsAction::FeaturesPageToggle(
                #[allow(deprecated)]
    ...
    toggle_binding_pairs.push(ToggleSettingActionPair::new(
        tr(current_locale(), MessageId::FeaturesLinkTooltip).as_ref(),
        builder(SettingsAction::FeaturesPageToggle(
    ...
    toggle_binding_pairs.push(
        ToggleSettingActionPair::new(
            tr(current_locale(), MessageId::FeaturesVimUnnamedRegister).as_ref(),
            builder(SettingsAction::FeaturesPageToggle(
    ...
    toggle_binding_pairs.push(
        ToggleSettingActionPair::new(
            tr(current_locale(), MessageId::FeaturesVimStatusBar).as_ref(),
            builder(SettingsAction::FeaturesPageToggle(
    ...
    #[cfg(any(target_os = "linux", target_os = "freebsd"))]
    {
        if windowing_system_is_customizable(app) {
            toggle_binding_pairs.push(
                ToggleSettingActionPair::new(
                    tr(current_locale(), MessageId::FeaturesWaylandWindowManagement).as_ref(),
                    builder(SettingsAction::FeaturesPageToggle(
    ...
    app.register_fixed_bindings([FixedBinding::empty(
        tr(current_locale(), MessageId::FeaturesConfigureGlobalHotkey).into_owned(),
    ...
    if DefaultTerminal::can_warp_become_default() {
        app.register_fixed_bindings([FixedBinding::empty(
            tr(current_locale(), MessageId::FeaturesMakeDefaultTerminal).into_owned(),
            builder(SettingsAction::FeaturesPageToggle(
...
impl FeaturesPageView {
        ...
        dropdown.update(
            ...
            |dropdown: &mut FilterableDropdown<FeaturesPageAction>, ctx| {
                ...
                let mut items: Vec<DropdownItem<FeaturesPageAction>> = DefaultSessionMode::iter()
                    ...
                    .map(|val| {
                        DropdownItem::new(
                            settings_display_text_static(val.display_name()),
                ...
                let selected_name = match current_mode {
                    DefaultSessionMode::TabConfig => tab_configs
                        ...
                        .map(|c| c.name.clone())
                        .unwrap_or_else(|| {
                            settings_display_text_static(
                                DefaultSessionMode::Terminal.display_name(),
                            )
                            .to_string()
                        }),
                    other => settings_display_text_static(other.display_name()).to_string(),
                };
        ...
        Container::new(
            Flex::row()
                ...
                .with_child(
                    appearance
                        .ui_builder()
                        .span(settings_display_text("Autohides on loss of keyboard focus"))
                        .build()
                        .with_margin_left(5.)
                        .finish(),
                )
            ...
            Flex::row()
                ...
                .with_child(
                    Shrinkable::new(
                        ...
                        Align::new(
                            Text::new_inline(
                                settings_display_text("Keybinding"),
                                appearance.ui_font_family(),
                                13.,
                            )
                ...
                .with_child(
                    Shrinkable::new(
                        ...
                        Align::new(if let Some(keybinding) = &keybinding.unsaved_binding {
                            ...
                            appearance
                                .ui_builder()
                                .paragraph(settings_display_text("Click to set global hotkey"))
                                .build()
                                .finish()
                        })
                        .finish(),
    ...
    fn render_clicked<T: Fn(&mut EventContext, Keystroke) + 'static>(
        ...
        let cancel_button = appearance
            ...
            .with_text_label(settings_display_text("Cancel"))
            .build()
            .on_click(move |ctx, _, _| {
    ...
    fn render_change_keybinding_button(
        ...
        Hoverable::new(
            ...
            |state| {
                ...
                Container::new(
                    Text::new_inline(
                        settings_display_text("Change keybinding"),
                        appearance.ui_font_family(),
                        12.,
                    )
        ...
        let input_column = Flex::column()
            .with_children([
                ...
                if view.valid_mouse_scroll_multiplier {
                    ...
                    appearance
                        .ui_builder()
                        .wrappable_text(settings_display_text("Allowed Values: 1-20"), true)
                        .with_style(UiComponentStyles {
...
impl SettingsWidget for DefaultTerminalWidget {
    ...
    fn render(
        ...
        if default_terminal.is_warp_default() {
            ui_builder
                .wrappable_text(settings_display_text("Warp is the default terminal"), true)
                .with_style(UiComponentStyles {
            ...
            ui_builder
                .link(
                    settings_display_text("Make Warp the default terminal"),
                    None,
                    Some(Box::new(|ctx| {
    ...
    fn render(
        ...
        Flex::column()
            .with_child(render_body_item::<FeaturesPageAction>(
                extra_meta_keys_left_text().into_owned(),
                None,
                LocalOnlyIconState::for_setting(
            ...
            .with_child(render_body_item::<FeaturesPageAction>(
                extra_meta_keys_right_text().into_owned(),
                None,
                LocalOnlyIconState::for_setting(
                    crate::terminal::keys_settings::ExtraMetaKeys::storage_key(),
                    crate::terminal::keys_settings::ExtraMetaKeys::sync_to_cloud(),
        ...
        if app.is_wayland() {
            column.add_child(render_body_item::<FeaturesPageAction>(
                ...
                Flex::row()
                    .with_children([
                        ui_builder
                            .span(settings_display_text("Not supported on Wayland. "))
                            .build()
                            .finish(),
                        ui_builder
                            .link(
    ...
    fn render(
        ...
        let mut tab_key_span = Flex::row()
            ...
            .with_child(
                appearance
                    .ui_builder()
                    .span(settings_display_text("Tab key behavior"))
                    .with_style(UiComponentStyles {
    ...
    fn render_word_char_config(
        ...
        Flex::column()
            .with_child(
                ui_builder
                    .label(
                        settings_display_text("Characters considered part of a word").to_string(),
                    )
                    .with_style(UiComponentStyles {
                        margin: Some(Coords {
                            top: 10.0,
...
impl SettingsWidget for DefaultSessionModeWidget {
    ...
    fn render(
        ...
        let label = render_dropdown_item_label(
            settings_display_text_static("Default mode for new sessions").to_string(),
            None,
            LocalOnlyIconState::for_setting(
