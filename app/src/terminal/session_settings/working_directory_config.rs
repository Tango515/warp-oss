...
use crate::settings_view::settings_page::settings_display_text_static;
...
impl WorkingDirectoryMode {
    ...
    pub fn dropdown_item_label(&self) -> &'static str {
        match self {
            WorkingDirectoryMode::HomeDir => settings_display_text_static("Home directory"),
            WorkingDirectoryMode::PreviousDir => {
                settings_display_text_static("Previous session's directory")
            }
            WorkingDirectoryMode::CustomDir => settings_display_text_static("Custom directory"),
        }
    }
}
