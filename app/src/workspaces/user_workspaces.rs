...
impl UserWorkspaces {
    ...
    /// In this OSS build, user-provided provider keys are always allowed so Agent can run
    /// against the user's own token plan instead of requiring a Warp subscription policy.
